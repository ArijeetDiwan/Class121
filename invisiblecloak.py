...
#fourcc is four characteer code (identifier for video)

fourcc = cv2.VideoWriter_fourcc(*'XVID')
output_file = cv2.VideoWriter('Okaymam.avi', fourcc, 20.0, (640, 480))
...
while (cap.isOpened()):
    ...
    cv2.imshow("Okay mam", final_output)
    cv2.waitKey(1)
